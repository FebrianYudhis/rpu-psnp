...
$kiri = "jenisruang.php";
$kanan = "peminjaman.php";
include('assets/template/header.php');
?>
<div class="konten">
    <div class="tulisan mt-2">
        <h2 class="center mb-2">Inventaris</h2>
        <p class="biasa">- Pada level admin,semua admin dapat menambahkan data inventaris barang,melihat, mengedit dan
            menghapusnya
        </p>
